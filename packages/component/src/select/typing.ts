...
export type CanUpdateISelectItem<ValueType> = Pick<ISelectItem<ValueType>, 'isChecked' | 'allowRepeatChecked' | 'value'>
...
export type CommonSelectItemProps<ValueType> = Pick<ISelectItem<ValueType>, 'id' | 'allowRepeatChecked' | 'value'>
